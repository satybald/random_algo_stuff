...
if javac -cp $CLASSPATH -d target -sourcepath src src/Deque.java src/RandomizedQueue.java src/Subset.java test/RandomQueueTest.java ; then
    if java -cp $CLASSPATH org.junit.runner.JUnitCore RandomQueueTest ; then
	    echo "8 elem"
